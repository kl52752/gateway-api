...
const (
	...
	SupportGatewayClientCertificateValidation FeatureName = "GatewayClientCertificateValidation"
)
...
var (
	...
	// GatewayClientCertificateValidationFeature contains metadata for the GatewayClientCertificateValidation feature.
	GatewayClientCertificateValidationFeature = Feature{
		Name:    SupportGatewayClientCertificateValidation,
		Channel: FeatureChannelExperimental,
	}
)
...
var GatewayExtendedFeatures = sets.New(
	...
	GatewayClientCertificateValidationFeature,
)
